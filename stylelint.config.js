module.exports = {
    "rules": {
        "at-rule-blacklist": [], // 指定不允许的at-rules黑名单。string | []
        "at-rule-whitelist": [], // 指定允许的at-rules的白名单。string | []
        "at-rule-empty-line-before": "never", // 在at-rules之前要求或禁止空行（Autofixable）。"always" | "never"
        "at-rule-name-case": "lower", // 为at-rules名称指定小写或大写（Autofixable）。"lower" | "upper"
        "at-rule-name-newline-after": "always-multi-line", // 在规则名称后需要换行符。 // "always" | "always-multi-line"
        "at-rule-name-space-after": "always", // 在规则名称后需要一个空格（Autofixable）。
        "at-rule-no-unknown": true, // 禁止未知的规则。
        "at-rule-no-vendor-prefix": true, // 禁止at-rules的前缀供应商。
        "at-rule-property-requirelist": {}, // 为at-rule指定属性的requirelist。
        "at-rule-semicolon-newline-after": "always", // 在at-rules分号后面需要换行符（Autofixable）。
        "at-rule-semicolon-space-before": "never", // 在at-rules的分号前需要单个空格或不允许空格。"always" | "never"
        "block-closing-brace-empty-line-before": "never", // 在关闭大括号（自动固定）之前需要或禁止空行。"always-multi-line" | "never"
        "block-closing-brace-newline-after": "always-single-line", // 在块的右大括号之后需要换行符或禁止空格（Autofixable）。"always" | "always-single-line" | "never-single-line" | "always-multi-line" | "never-multi-line"
        // "block-closing-brace-newline-before": "never-multi-line", // 在块的右大括号后需要单个空格或不允许空格。"always" | "always-multi-line" | "never-multi-line"
        "block-closing-brace-space-after": "always-single-line", // 在关闭大括号块之前需要换行符或禁止空格。"always" | "always-single-line" | "never-single-line" | "always-multi-line" | "never-multi-line"
        "block-closing-brace-space-before": "always-single-line", // 在关闭大括号块（Autofixable）之前需要换行符或禁止空格。"always" | "never" | "always-single-line" | "never-single-line" | "always-multi-line" | "never-multi-line"
        "block-no-empty": true, // 禁止空块。
        "block-opening-brace-newline-after": "always", // 在打开大括号后需要一个换行符。"always" | "always-multi-line" | "never-multi-line"
